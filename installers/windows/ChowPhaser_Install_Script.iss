...
DefaultGroupName=ChowPhaser
OutputBaseFilename="ChowPhaser-Win-##APPVERSION##"
OutputDir=.
LicenseFile=../../LICENSE
...
[Files]
Source: "../../bin/Win64/ChowPhaserMono.vst3"; DestDir: "{code:GetDir|VST3_64}"; Components: VST3_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/ChowPhaserStereo.vst3"; DestDir: "{code:GetDir|VST3_64}"; Components: VST3_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/ChowPhaserMono.dll"; DestDir: "{code:GetDir|VST_64}"; Components: VST_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win64/ChowPhaserStereo.dll"; DestDir: "{code:GetDir|VST_64}"; Components: VST_64; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/ChowPhaserMono.vst3"; DestDir: "{code:GetDir|VST3_32}"; Components: VST3_32; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/ChowPhaserStereo.vst3"; DestDir: "{code:GetDir|VST3_32}"; Components: VST3_32; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/ChowPhaserMono.dll"; DestDir: "{code:GetDir|VST_32}"; Components: VST_32; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "../../bin/Win32/ChowPhaserStereo.dll"; DestDir: "{code:GetDir|VST_32}"; Components: VST_32; Flags: ignoreversion recursesubdirs createallsubdirs
