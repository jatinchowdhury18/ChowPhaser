...
script_file=ChowPhaser.pkgproj
...
npx notarize-cli --file $pkg_dir/ChowPhaser-signed.pkg --bundle-id com.chowdsp.ChowPhaser --asc-provider "$TEAM_ID" --username chowdsp@gmail.com --password "$INSTALLER_PASS"

echo "Building disk image..."
vol_name=Install_ChowPhaser-$app_version
